...
const Home: NextPage = () => {
  return (
    <div className="m-0 font-helvetica text-white bg-[#10002B]">
      ...
      <div className="aspect-[960/300] w-full bg-no-repeat bg-center bg-cover bg-[url('https://cdn.discordapp.com/attachments/808664711800291358/984951946156851210/layered-waves-haikei1.svg')]"></div>
